...
export function FinancialInsights() {
  ...
  const topSpendingCategories = [...data.expenses.categories].sort((a, b) => b.amount - a.amount).slice(0, 3)
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="rounded-lg border p-3">
              ...
              <p className="text-lg font-bold text-green-500">${data.income.total.toFixed(2)}</p>
            </div>
            <div className="rounded-lg border p-3">
              <div className="flex items-center gap-1">
              ...
              <p className="text-lg font-bold text-red-500">${data.expenses.total.toFixed(2)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="rounded-lg border p-3">
              ...
              <p
                className={`text-sm font-medium ${data.expenses.trend.vsLastMonth < 0 ? "text-green-500" : "text-red-500"}`}
              >
                {data.expenses.trend.vsLastMonth > 0 ? "+" : ""}
            ...
            <div className="rounded-lg border p-3">
              ...
              <p
                className={`text-sm font-medium ${data.expenses.trend.vsLastYear < 0 ? "text-green-500" : "text-red-500"}`}
              >
                {data.expenses.trend.vsLastYear > 0 ? "+" : ""}
        ...
        <div className="space-y-2">
          ...
          <div className="rounded-lg border p-3">
            ...
            <div className="mt-2 h-1.5 rounded-full bg-muted">
              <div className="h-full rounded-full bg-[#2BD98E]" style={{ width: `${data.budget.percentUsed}%` }}></div>
            </div>
          </div>
        </div>
      </CardContent>
